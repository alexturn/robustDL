...
weight_dict_1 = torch.load('model_weights/vgg_random_weights_0.pth', map_location='cpu')
weight_dict_2 = torch.load('model_weights/vgg_random_weights_1.pth', map_location='cpu')
weight_dict_3 = torch.load('model_weights/vgg_random_weights_2.pth', map_location='cpu')
...
np.save('./plots/X_cifar_random', X)
np.save('./plots/Y_cifar_random', Y)
np.save('./plots/Z_cifar_random', Z_)
